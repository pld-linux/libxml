...
%description -l pl
Biblioteka libxml umoøliwia manipulowanie zawarto∂ci± plikÛw XML.

%package devel
Summary:	Header files etc to develop libxml applications
Summary(pl):	Pliki nag≥Ûwkowe i inne do libxml
...
Pakiet ten zawiera pliki nag≥Ûwkowe i inne do libxml niezbÍdne przy
